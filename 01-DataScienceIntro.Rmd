...
%md
##About me:
- Data Scientist Leader at Slalom.     
- Previous experience in Cannabis, biotech and molecular diagnostics fields developing and validating end to end ML models. 
- BSc - CMPT & Microbiology/biochemistry from SFU.      
- At Vancouver Datajam 2021, I will be teaching R Workshop - special topic: Machine Learning.    
- Pronouns: he/him.
...
```{r}
%md
## Feel free to connect, follow and ask questions

####LinkedIn: in/zaid-haddad    https://www.linkedin.com/in/zaid-haddad/        
####Twitter:  @zaid_ha         
####Github:  haddadz      https://github.com/haddadz
```


### Advanced R workshop   
- Mainly using R 
- This workshop will be focused on Unsupervised learning
- Assuming some stats background and geared towards advanced R users
- Assuming basic knowledge of R and the tidyverse package
...
## Once done, introduce yourself on Discord
```
...
- https://lgatto.github.io/IntroMachineLearningWithR/unsupervised-learning.html#hierarchical-clustering
- https://bradleyboehmke.github.io/HOML/intro.html#data
